...
import { ScriptureChapter, BiblicalDifficulty } from '../types';
        ...
        >
          ...
          <div className="space-y-3">
            {chap.verses.map((verse) => {
              ...
              const verseDifficulties = getDifficultiesForVerse(chap.book, chap.chapter, verse.verse);
              ...
              return (
                ...
                >
                  ...
                  <span className="opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1 shrink-0 select-none ml-2">
                    <button
                      type="button"
                      onClick={() => onToggleHighlightVerse(chap.book, chap.chapter, verse.verse)}
                    ...
                    <button
                      type="button"
                      onClick={() => onCopyVerse(chap.book, chap.chapter, verse.verse, verse.text)}
